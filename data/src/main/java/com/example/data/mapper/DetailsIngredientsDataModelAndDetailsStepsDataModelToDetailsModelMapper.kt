...
object DetailsIngredientsDataModelAndDetailsStepsDataModelToDetailsModelMapper: ((DetailsIngredientsDataModel, List<DetailsStepsDataModel>)->DetailsModel) {
    override fun invoke(ingredientsDM: DetailsIngredientsDataModel, stepsDM: List<DetailsStepsDataModel>): DetailsModel {
        return DetailsModel(
            id = ingredientsDM.id,
