...
class GetDetailsUseCase(private val repository: RecipeRepository): (suspend (Int)->DetailsModel) {
    override suspend fun invoke(recipeId: Int): DetailsModel {
        return repository.getDetails(recipeId)
//        DetailsModel(
//            id = 0,
//            title = "Borsch",
